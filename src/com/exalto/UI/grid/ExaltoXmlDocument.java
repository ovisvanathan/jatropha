...
public class ExaltoXmlDocument extends ExaltoXmlNode implements Transferable {
    // implements Transferable {
    
    ExaltoXmlDocument userData;
    ...
    public ExaltoXmlDocument() {
        
    }
    
    public ExaltoXmlDocument(Node node) {
        super(node);
        this.theNode = node;
    ...
    public ExaltoXmlDocument(ExaltoXmlDocument node) {
        this.userData = node;
        this.theNode = node.getXmlNode();
    }
    
    public ExaltoXmlDocument(TreeNode node) {
        this.userData = (ExaltoXmlDocument) node;
 ...
 //       return null;
    ...
    throws UnsupportedFlavorException,
        ...
        if (flavor.equals(flavors[TREE])) {
            ...
            // and extra cloning
            if (this instanceof ExaltoXmlDocument) {
                returnObject = this;
            } else {
