...
public class ExaltoXmlCData extends ExaltoXmlNode implements Transferable {
    // implements Transferable {
    
    ExaltoXmlCData userData;
...
//    Node cdata;
    ...
    public ExaltoXmlCData() {
        
    }
    
    public ExaltoXmlCData(Node node) {
        super(node);
        this.theNode = node;
    ...
    public ExaltoXmlCData(org.w3c.dom.CDATASection node) {
        super(node);
    	this.theNode = node;
    }
    
    public ExaltoXmlCData(ExaltoXmlCData node) {
        this.userData = node;
        this.theNode = node.getXmlNode();
    }
 /*
    public ExaltoXmlPI(String target, String  data) {
    	if(document != null)
    		procInstr = document.createProcessingInstruction(target, data);
    }
*/
    
    public ExaltoXmlCData(TreeNode node) {
        this.userData = (ExaltoXmlCData) node;
 ...
 //       return null;
    ...
    throws UnsupportedFlavorException,
        ...
        if (flavor.equals(flavors[TREE])) {
            ...
            // and extra cloning
            if (this instanceof ExaltoXmlCData) {
                returnObject = this;
            } else {
