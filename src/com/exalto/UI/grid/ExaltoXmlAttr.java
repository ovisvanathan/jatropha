...
public class ExaltoXmlAttr extends ExaltoXmlNode implements Transferable {
    // implements Transferable {
    
    ExaltoXmlAttr userData;
    ...
    public ExaltoXmlAttr() {
        
    }
    
    public ExaltoXmlAttr(Node node) {
        super(node);
        this.theNode = node;
    ...
    public ExaltoXmlAttr(Attr node) {
        super(node);
    	this.attr = node;
        this.theNode = node;
    }
/*    
    public ExaltoXmlAttr(String  data) {
    	if(document != null)
    		theNode = document.createAttribute(data);
    	
    }
*/
    
    public ExaltoXmlAttr(ExaltoXmlAttr node) {
        this.userData = node;
        this.theNode = node.getXmlNode();
        
    }
    
    public ExaltoXmlAttr(TreeNode node) {
        this.userData = (ExaltoXmlAttr) node;
...
*/        
    ...
    throws UnsupportedFlavorException,
        ...
        if (flavor.equals(flavors[TREE])) {
            ...
            // and extra cloning
            if (this instanceof ExaltoXmlAttr) {
                returnObject = this;
            } else {
