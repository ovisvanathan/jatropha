...
public class ExaltoXmlPI extends ExaltoXmlNode implements Transferable {
    // implements Transferable {
    
    ExaltoXmlPI userData;
    ...
    public ExaltoXmlPI(org.w3c.dom.ProcessingInstruction node) {
        super(node);
    	this.theNode = node;
    }
    
    public ExaltoXmlPI(ExaltoXmlPI node) {
        this.userData = node;
...
*/
    ...
    public ExaltoXmlPI(TreeNode node) {
        this.userData = (ExaltoXmlPI) node;
 ...
 //       return null;
    ...
    throws UnsupportedFlavorException,
        ...
        if (flavor.equals(flavors[TREE])) {
            ...
            // and extra cloning
            if (this instanceof ExaltoXmlPI) {
                returnObject = this;
            } else {
