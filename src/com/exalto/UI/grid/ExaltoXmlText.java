...
public class ExaltoXmlText extends ExaltoXmlNode implements Transferable {
    // implements Transferable {
    
    ExaltoXmlText userData;
...
//    Node text;
    ...
    public ExaltoXmlText() {
        
    }
    
    public ExaltoXmlText(Node node) {
        super(node);
        this.theNode = node;
    ...
    public ExaltoXmlText(org.w3c.dom.Text node) {
    	super(node);
    	this.theNode = node;
    }
    
    public ExaltoXmlText(ExaltoXmlText node) {
        this.userData = node;
        this.theNode = node.getXmlNode();
    }
    
    public ExaltoXmlText(TreeNode node) {
        this.userData = (ExaltoXmlText) node;
 ...
 //       return null;
    ...
    throws UnsupportedFlavorException,
        ...
        if (flavor.equals(flavors[TREE])) {
            ...
            // and extra cloning
            if (this instanceof ExaltoXmlText) {
                returnObject = this;
            } else {
