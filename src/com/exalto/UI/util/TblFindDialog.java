 ...
 */
public class TblFindDialog extends JDialog {
...
//	private JRadioButton downButton		= null;
	 ...
	 */
	public TblFindDialog( Searchable searchable) {
	// 	super( (JFrame) table, false);
	...
	//		getTable().searchIndex = -1;
		}
		
		public void windowDeactivated(WindowEvent e) {
		//	getTable().searchData = null;
		}
		};
...
// ov uncommented 25/3/05		
	    this.setTitle("Find and Replace of grid");
//	    this.setTitle("Find");
