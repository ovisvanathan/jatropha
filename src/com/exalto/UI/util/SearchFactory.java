...
import com.exalto.UI.util.TableFindDlg;
...
public class SearchFactory {
    ...
    //OV added 21/06/2006
 //   TableFindDlg dialog = null;
           GridFindDialog dialog = null;
     ...
     */
    public void showFindInput(JFrame parent, JComponent target, Searchable searchable) {
      //  if (isUseFindBar(target, searchable)) {
      //      showFindBar(target, searchable);
      //  } else {
            showFindDialog(parent, target, searchable);
      //  }
    }
...
//                releaseFindBar();
	...
	*/    
     ...
     */
    public void showFindDialog(JFrame parent, JComponent target, Searchable searchable) {
...
//            findDialog.setAlwaysOnTop(true);
    ...
    */
		System.out.println(" showing tbl find dialog = " +dialog);    
    
	//	dialog = new TableFindDlg(parent, false, target, searchable);
	dialog = new GridFindDialog(parent, false, target, searchable);
