...
import javax.swing.JComponent;
 ...
 public final class MultiViewTopComponent extends JComponent implements MultiViewModel.ActionRequestObserverFactory {
 
 //    MultiViewPeer peer;
	 MultiViewDescription[] descriptions;
	 MultiViewDescription defaultDesc;
	 CloseOperationHandler handler;
 ...
 */
     ...
     public String  toString() {
         return "MultiViewTopComponent[name=" + getDisplayName(); // NOI18N
     }
