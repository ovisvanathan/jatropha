 ...
 */
@JavaBean
public class JXTreeTable2 extends JXTable {
     ...
     *                instance.
     */
    private JXTreeTable2(TreeTableCellRenderer renderer) {
    ...
    public void init(TreeTableCellRenderer renderer) {
        ...
        PropertyChangeListener l = new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                JXTreeTable2.this.renderer.putClientProperty(evt.getPropertyName(), evt.getNewValue());
...
//------------------------------ exposed tree listeners
    ...
    public static class TreeTableModelAdapter extends AbstractTableModel 
		...
		public final JTree tree; // immutable
   
		//OM
		public JXTreeTable2 treeTable; // logically immutable
         ...
         */
        public TreeTableModelAdapter(JTree tree) {
...
//            treeTable.getTreeTableHacker().setExpansionChangedFlag();
         ...
         */
        protected JXTreeTable2 getTreeTable() {
            return treeTable;
        }
         ...
         */
        protected final void bind(JXTreeTable2 treeTable) {
...
//                            LOG.info("Updated: parentPath/min/max" + path + "/" + min + "/" + max);
    ...
    public static class TreeTableDataAdapter extends JXTable.TableAdapter {
        private final JXTreeTable2 table;
         ...
         */
        public TreeTableDataAdapter(JXTreeTable2 component) {
            super(component);
            table = component;
        }
        
        public JXTreeTable2 getTreeTable() {
            return table;
        }
